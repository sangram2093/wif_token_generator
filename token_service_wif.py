...
def retrieve_gcp_svc_token(audience: str) -> str:
    ...
    # Create google.auth Credentials object from raw token
    sts_credentials = Credentials(token=access_token)

    # Impersonate again (optional — if you directly stored impersonated SA token, skip this)
    # target_principal should match your WIF target SA email
